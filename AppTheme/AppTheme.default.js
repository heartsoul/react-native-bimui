...
export default {
  ...
  navBarTintColor:defaultColor,
  navBarColor:primaryColor,
  navBarShadowColor:primaryColor,
  pageColor: '#f8f8f8',
  pixelSize,

  // Label - color
  labelTextActionColor: primaryColor,
  labelTextMenuActionColor: primaryColor,
  labelTextAlertColor: primaryColor,
